...
<body>
    ...
    <div class="logout_btn">
        <a href="index.php" class="btn btn-primary btn-large">Leave <i class="icon-white icon-check"></i></a>
    </div>
    
    <div class="img_home_pos">
        <a href="everyone.php"><img src="images/logo.png" height="75" alt="Project" /></a><span class="header_pos">K.S INSTITUTE OF TECHNOLOGY</span>
    </div><br>
        ...
        <div class="bottom_pos">
            <a href="AboutManagement.php" style="text-decoration: none; color:darkred"><b>About Me</b></a>
        </div>
</body>
</html>